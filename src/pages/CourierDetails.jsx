      ...
      {!editing && courierInfo ? (
        <Card className="mb-4">
          ...
          <Card.Body>
            ...
            <Row>
              ...
              <Col md={4}>
                <p>
                  ...
                  {courierInfo.courierService === 'Pickup' ? (
                    <Badge bg="success">Free - Local Pickup</Badge>
                  ) : (
                    `₹${courierInfo.estimatedCost}`
                  )}
                </p>
              </Col>
              <Col md={4}>
            ...
            {courierInfo.notes && (
              <p className="text-muted small mb-0"><strong>Notes:</strong> {courierInfo.notes}</p>
            )}
        ...
        <Card className="mb-4">
          ...
          <Card.Body>
            <Form onSubmit={handleSubmit}>
              ...
              {formData.courierService === 'Pickup' && (
                <Alert variant="success" className="small py-2">
                  Local Pickup selected — no shipping cost will apply.
                </Alert>
              )}
